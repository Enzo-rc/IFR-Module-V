...
//Elle devra retourner un boolean qui vaut true si le password fait au moins 8 caractères et false si moins.
    ...
    {
    //strlen fonction qui retourne un nombre
...
//Il faudra utiliser la structure SWITCH pour faire cette exercice.
    ...
    {
    case "France": 
    return $tableaucapitales['France'] ;
    break;
    case 'Allemagne': 
    return $tableaucapitales['Allemagne'];
    break;
    case 'Italie': 
    return $tableaucapitales['Italie'] ;
    break;
    case 'Maroc': 
    return $tableaucapitales['Maroc'] ;
    break;
    case 'Espagne': 
    return $tableaucapitales['Espagne'] ;
    break;
    case 'Portugal': 
    return $tableaucapitales['Portugal'] ;
    break;
    case 'Angleterre': 
    return $tableaucapitales['Angleterre'] ;
    break;
    default:
    return $tableaucapitales = "inconnu" ;
    break;
    }
    }
    echo capital("");
