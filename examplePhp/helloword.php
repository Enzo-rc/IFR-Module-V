...
echo "<br><strong>Exercice 1</strong><br>"; //Modifier le code ci-dessous pour calculer la moyenne des notes.
$note_maths = 15;
$note_francais = 12;
$note_histoire_geo = 9;
$moyenne = ($note_maths + $note_francais + $note_histoire_geo)/3;
echo 'La moyenne est de '.$moyenne.' / 20.<br><br>'; // (note1 + note2 + note3) / nbre de notes


echo "<br><br><strong>Exercice 2</strong><br>"; //Calculer le prix TTC du produit.
$prix_ht = 50;
$tva = 20;
...
foreach( $pays as $ville){ // on parcourt $pays, la valeur de l'item courant est copiée dans $ville
...
echo "<br><br><strong>Exercice 13</strong><br>";
...
echo "<br><br><strong>Exercice 14</strong>";
...
echo "<br><br><strong>Exercice 15</strong><br>";
